...
import com.internship.sbproject1.BaseControllerTest;
...
import com.internship.sbproject1.repository.UserRepositoryTest;
...
public class UserControllerTest extends TestCreationFactory {
    ...
    public void saveUserTest() throws Exception {
        ...
        mockMvc.perform(post(USERs_URL).contentType(MediaType.APPLICATION_JSON).content(objectMapper.writeValueAsString(requestUserDto)))
                .andExpect(status().isOk());
